...
def Attack():
    ...
    set(new_health)   
'''
#The Problem: The problem is that when I attempt to click the attack button instead of lowerin the health and in turn lowering the slider it doesnt do any of
# that and states set statement has syntax issues.
#The Finished Product: The program should allow the user to click the attack button and continue to lower the slider until it reaches 0 at which point the window will
#close and say you have won or something.
def OpenImage():
